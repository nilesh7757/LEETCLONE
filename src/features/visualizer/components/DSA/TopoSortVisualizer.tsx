    ...
    <div className="flex flex-col gap-6">
      <div className="p-4 md:p-8 bg-[var(--card)] rounded-3xl shadow-2xl font-sans text-foreground relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div ref={containerRef} className="lg:col-span-8 relative min-h-[350px] md:min-h-[450px] w-full bg-muted/40 rounded-[2.5rem]  overflow-x-auto overflow-y-hidden touch-pan-x no-scrollbar shadow-inner flex flex-col items-center justify-center p-4 md:p-8">
                
                {/* Logic Step Badge */}
                <AnimatePresence>
                    {currentStep.step !== "IDLE" && (
                        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="absolute top-4 left-4 md:top-8 md:left-10 flex items-center gap-2 px-4 py-2 bg-[var(--viz-rose)]/10 border border-[var(--viz-rose)]/30 rounded-full z-30 shadow-lg">
                ...
                <AnimatePresence mode="wait">
                    <motion.div key={currentIndex} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="absolute bottom-8 w-full max-w-[400px] px-4 md:px-10 text-center z-30">
            ...
            <div className="lg:col-span-4 flex flex-col gap-6">
                <div className="p-3 md:p-6 bg-muted  rounded-[2rem] flex flex-col gap-4">
                    ...
                    <div className="flex flex-wrap gap-2 justify-center min-h-[350px] md:min-h-[40px] w-full overflow-x-auto overflow-y-hidden touch-pan-x no-scrollbar">
                        <AnimatePresence>
