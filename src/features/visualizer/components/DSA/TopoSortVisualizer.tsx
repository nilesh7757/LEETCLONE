    ...
    <div className="flex flex-col gap-6">
      <div className="p-4 md:p-8 bg-[var(--card)] rounded-3xl shadow-2xl font-sans text-foreground relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div ref={containerRef} className="lg:col-span-8 relative min-h-[450px] bg-muted/40 rounded-[2.5rem]  overflow-hidden shadow-inner flex flex-col items-center justify-center p-4 md:p-8">
