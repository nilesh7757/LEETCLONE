        ...
        <div className="flex items-center justify-between mb-12 relative z-10">
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-2">
               ...
               <p className="text-[10px] font-mono uppercase tracking-widest text-muted-foreground/30">Extremum Search Protocol</p>
            </div>
          </div>
                ...
                <motion.div key={currentIndex} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="absolute bottom-12 w-full max-w-[500px] px-4 md:px-10 text-center z-30">
                    <div className="p-4 bg-primary/5 border border-primary/20 rounded-2xl backdrop-blur-md shadow-2xl">
                        <div className="flex items-center justify-center gap-2 mb-1 opacity-40">
                            ...
                            <span className="text-[8px] font-black uppercase tracking-tighter text-foreground">Logic Stream</span>
                        </div>
                    ...
                    return (
                        <motion.div
                            ...
                            animate={{ 
                                ...
                                height: `${node.value}%`,
                                backgroundColor: isSwapping ? MANIM_COLORS.red : isMin ? MANIM_COLORS.purple : isComparing ? MANIM_COLORS.gold : isSorted ? MANIM_COLORS.green : "rgba(160,97,255,0.1)",
                                borderColor: isSwapping ? MANIM_COLORS.red : isMin ? MANIM_COLORS.purple : isComparing ? MANIM_COLORS.gold : isSorted ? MANIM_COLORS.green : "rgba(160,97,255,0.3)",
