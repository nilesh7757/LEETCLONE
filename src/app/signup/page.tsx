    ...
    <div className="min-h-screen w-full flex bg-[#080808] overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 lg:ml-[50%] min-h-screen bg-gradient-to-r from-[#080808] to-[#131313] flex flex-col items-center justify-center p-4 sm:p-8 relative z-10">
        ...
        <div className="w-full max-w-[420px] bg-[#111111] border border-white/10 rounded-xl shadow-2xl p-6 sm:p-8">
            ...
            {error && (
                <div className="mb-4 p-3 bg-red-500/10 text-red-400 text-sm rounded-lg text-center border border-red-500/20">
                    {error}
                </div>
            )}
            ...
            <form onSubmit={handleCredentialSignup} className="flex flex-col gap-4">
                <div className="flex flex-col gap-1.5">
                    ...
                    <input
                        ...
                        required
                        className="w-full h-10 px-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder:text-neutral-500 focus:outline-none focus:ring-2 focus:ring-[#8F44F0]/30 focus:border-[#8F44F0]/60 transition-all text-sm"
                    />
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative">
                        <input
                            ...
                            required
                            className="w-full h-10 px-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder:text-neutral-500 focus:outline-none focus:ring-2 focus:ring-[#8F44F0]/30 focus:border-[#8F44F0]/60 transition-all text-sm pr-10"
                        />
                        <button 
                            type="button"
            ...
            <div className="relative flex items-center my-6">
                ...
                <span className="flex-shrink mx-4 text-neutral-500 text-xs uppercase font-medium">Or continue with</span>
                <div className="flex-grow border-t border-white/10"></div>
            </div>
            ...
            <button
                ...
                disabled={loading}
                className="w-full h-10 bg-white/5 border border-white/10 hover:bg-white/10 text-white font-medium rounded-full text-sm transition-all flex items-center justify-center gap-2"
            >
               {/* Google Icon */}
