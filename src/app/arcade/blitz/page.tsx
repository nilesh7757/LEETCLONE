    ...
    <div className="min-h-screen bg-[#020202] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="max-w-xl w-full relative z-10">
        ...
        <div className="flex justify-between items-center mb-12">
          <Link href="/arcade" className="p-3 bg-white/5 rounded-2xl hover:bg-white/10 transition-all">
            <ArrowLeft size={20} />
          </Link>
          ...
          {gameState === "START" && (
            ...
            >
              ...
              <div>
                ...
                <p className="text-[#52525b] font-medium max-w-sm mx-auto leading-relaxed">
            ...
            >
              <div className="flex justify-between items-end">
                <div className="space-y-1">
                    <div className="text-[10px] font-black uppercase tracking-widest text-[#52525b]">Current Score</div>
                    <div className="text-5xl font-black font-mono">{score}</div>
                </div>
                <div className="text-right space-y-1">
                    <div className="flex items-center justify-end gap-2 text-[10px] font-black uppercase tracking-widest text-[#52525b]">
              ...
              <motion.div 
                ...
                className={`p-12 rounded-[3rem] bg-[#0a0a0a] border-2 text-center transition-all duration-300 ${
              ...
              >
                <div className="text-[10px] font-black uppercase tracking-[0.4em] text-[#52525b] mb-4">Challenge Node</div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {OPTIONS.map((opt) => (
                  <button
                    ...
                    className="p-4 rounded-2xl bg-white/5 border border-white/5 hover:border-white/20 hover:bg-white/10 transition-all text-sm font-black font-mono active:scale-95"
                  >
                    {opt}
                  </button>
                ))}
          ...
          {gameState === "ENDED" && (
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-[#52525b] font-medium">Session successfully synced to the mainframe.</p>
              </div>

              <div className="grid grid-cols-2 gap-6 max-w-sm mx-auto">
                 <div className="p-6 bg-white/5 rounded-3xl border border-white/5">
                    <div className="text-[10px] font-black uppercase tracking-widest text-[#52525b] mb-2">Final Score</div>
                    <div className="text-4xl font-black font-mono">{score}</div>
                 </div>
                 <div className="p-6 bg-white/5 rounded-3xl border border-white/5">
                    <div className="text-[10px] font-black uppercase tracking-widest text-[#52525b] mb-2">Reward</div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <Link 
                  href="/arcade"
                  className="px-12 py-5 bg-white/5 text-white font-black uppercase tracking-[0.3em] rounded-[2rem] hover:bg-white/10 transition-all"
                >
                  Return to Hub
                </Link>
              </div>
