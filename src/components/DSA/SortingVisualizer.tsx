  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="p-8 bg-[#1C1C1C] border border-[#333333] rounded-3xl shadow-2xl font-sans text-white relative overflow-hidden">
        ...
        <div className="flex items-center justify-between mb-12 relative z-10">
          <div className="space-y-1">
            <h2 className="text-2xl font-light tracking-tight text-[#58C4DD]">
              Bubble Sort <span className="text-white/40">Analysis</span>
            </h2>
            <div className="flex items-center gap-2">
               <div className="h-1 w-12 bg-[#58C4DD] rounded-full" />
               <p className="text-[10px] font-mono uppercase tracking-widest text-white/30">Temporal Manifold Navigation</p>
            </div>
          </div>
        ...
        {/* The "Video" Canvas */}
        <div className="relative min-h-[480px] bg-black/40 rounded-[2.5rem] border border-white/5 overflow-hidden shadow-2xl flex flex-col items-center justify-center px-10">
            
            {/* Range Highlight (Active Lemma) */}
            {currentStep.comparisonRange && (
                <motion.div 
                    className="absolute bottom-20 border-2 border-[#FFFF00]/20 bg-[#FFFF00]/5 rounded-2xl z-0"
                    animate={{ 
            ...
            <div className="relative w-full h-full flex items-end justify-center pb-32">
                {currentStep.nodes.map((node) => {
                    ...
                    return (
                        ...
                        >
                            <span className={`text-xs font-bold ${isComparing || isSwapping ? 'text-black' : 'text-white/60'}`}>{node.value}</span>
        ...
        <div className="mt-8 p-6 bg-white/5 border border-white/10 rounded-[2.5rem] flex flex-col gap-4 relative z-10">
            <div className="flex items-center justify-between px-2">
                <div className="flex items-center gap-3">
                    <Hash size={14} className="text-[#FFFF00]" />
      ...
      <div className="px-10 py-6 bg-white/[0.02] border border-white/5 rounded-[2.5rem] flex items-center justify-center gap-12">
         <div className="flex items-center gap-3"><div className="w-2.5 h-2.5 rounded-full bg-[#FFFF00]" /><span className="text-[10px] font-bold uppercase text-white/30 tracking-widest">Scanning Manifold</span></div>
         <div className="flex items-center gap-3"><div className="w-2.5 h-2.5 rounded-full bg-[#FC6255]" /><span className="text-[10px] font-bold uppercase text-white/30 tracking-widest">Active Displacement</span></div>
         <div className="flex items-center gap-3"><div className="w-2.5 h-2.5 rounded-full bg-[#83C167]" /><span className="text-[10px] font-bold uppercase text-white/30 tracking-widest">Ordered Manifold</span></div>
      </div>
    </div>
  );
}